...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>kotlin.kapt</b> with value <b>1.6.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final KaptPluginAccessors paccForKaptPluginAccessors = new KaptPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.kapt</b>
         */
        public KaptPluginAccessors getKapt() {
            return paccForKaptPluginAccessors;
        }
    ...
    public static class KaptPluginAccessors extends PluginFactory {

        public KaptPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>kapt.plugin</b> with plugin id <b>orgs.jetbrains.kotlin.kapt</b> and
         * with version reference <b>kotlin.kapt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugin() { return createPlugin("kapt.plugin"); }
